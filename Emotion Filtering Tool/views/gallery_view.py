...
class GalleryView(ttk.Frame):
    def __init__(self, master=None):
        ...
        self.create_widgets()
        #self.testImage()                       # Test fill the gallery with images

    def testImage(self):
        # any folder with images
        folder_path = "C:/Users/jacob/Desktop/temp/Humans"
        
        # Loop through all the files in the folder
        for file_name in os.listdir(folder_path):
            # Join folder path with file name to get the full path
            file_path = os.path.join(folder_path, file_name)
            #file_path = "C:/Users/jacob/Desktop/temp/Humans/1 (107).png"

            # Check if it's a file (and not a directory) and has a .jpeg or .jpg extension
    ...
    def add_image_to_gallery(self, image):
        try:
            ...
            label.grid(row=self.current_row, column=self.current_col, sticky="nw", padx=5, pady=5)  
        except Exception as e:
